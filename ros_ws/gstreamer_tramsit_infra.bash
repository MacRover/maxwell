...
#timeout 30s
gst-launch-1.0 v4l2src device=/dev/video2 io-mode=2 !  videoconvert !  video/x-raw,width=640,height=480,framerate=30/1,format=GREY8 !   nvvidconv ! nvv4l2h265enc bitrate=2000000 preset-level=1 control-rate=1 !   h265parse !   rtph265pay config-interval=1 mtu=1500 aggregate-mode=1 !   udpsink host=192.168.1.199 port=40628 sync=false max-lateness=333333
sleep 1
done
