...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : PAPin PAPin PAPin PAPin
                           PAPin */
  GPIO_InitStruct.Pin = LS_1_Pin|LS_2_Pin|FSR_1_Pin|FSR_2_Pin
                          |DRIVER_SG_TEST_Pin;
  ...
  /*Configure GPIO pins : PB1 PB10 PB11 PB5
                           PB8 PB9 */
  GPIO_InitStruct.Pin = GPIO_PIN_1|GPIO_PIN_10|GPIO_PIN_11|GPIO_PIN_5
