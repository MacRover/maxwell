...
int main(void)
{
  ...
  while (1)
  {
    ...
    while (HAL_I2C_Master_Transmit(&hi2c2, (uint16_t)i2c_address, i2c_send_data_io, 2, 10000) != HAL_OK)
    {
      if (HAL_I2C_GetError(&hi2c2) != HAL_I2C_ERROR_AF)
      {
        Error_Handler();
    ...
    while (HAL_I2C_Master_Receive(&hi2c2, (uint16_t)i2c_address, &i2c_read_data_io, 12, 10000) != HAL_OK)
    {
      if (HAL_I2C_GetError(&hi2c2) != HAL_I2C_ERROR_AF)
      {
        Error_Handler();
