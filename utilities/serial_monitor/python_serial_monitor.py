## Copied from https://github.com/adamwtow/python-serial-monitor/blob/master/python-serial-monitor.py
...
class PythonSerialMonitor():
    ...
    def run(self):
        ...
        ##MODIFY BELOW TO MATCH USB_TTL Device Descriptor
